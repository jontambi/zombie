...
variable "sg_name" {
  type        = string
  description = "Name to be used on all the Security Groups resources as identifier."
}

variable "iam_name" {
  type        = string
  description = "Name to be used on all the IAM Roles resources as identifier."
}
